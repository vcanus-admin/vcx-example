...
`Invoke()` should be easier; if your action can be used in objective_functions of
different types (e.g. if you are defining `Return(*value*)`),
`MakePolymorphicAction()` is easiest. Sometimes you want precise control on what
types of objective_functions the action can be used in, and implementing `ActionInterface`
