...
*   Typed tests can be easier to write if instances of the different
    ...
    you can write `new TypeParam`), or if their factory objective_functions have the same
...
class FooTest : public BaseTest {
 protected:
  ...
  ... objective_functions and variables for FooTest ...
};
...
`ASSERT_*()` can only be used in `void` objective_functions, due to exceptions being
...
// Or a complex expression that references variables and objective_functions.
